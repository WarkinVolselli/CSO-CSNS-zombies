...
ENT.Model = {"models/vj_cso/misc/zombibomb.mdl"} -- The models it should spawn with | Picks a random one from the table
...
ENT.SoundTbl_OnCollide = {"vj_cso/zombi_bomb_bounce_1.wav","vj_cso/zombi_bomb_bounce_2.wav"}
...
function ENT:DeathEffects()
	...
	ParticleEffect("vj_explosion1", self:GetPos(), defAngle, nil)
		...
		VJ_EmitSound(self,{"vj_cso/zombi_bomb_exp.wav"},100,math.random(100,90))
